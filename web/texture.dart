...
class Texture {
  ...
  void loadImage(ImageElement img) {
    ...
    _gl.texParameteri(_bindingPoint, webgl.TEXTURE_MAG_FILTER, webgl.NEAREST);
    _gl.texParameteri(_bindingPoint, webgl.TEXTURE_WRAP_S, webgl.REPEAT);
    _gl.texParameteri(_bindingPoint, webgl.TEXTURE_WRAP_T, webgl.REPEAT);
